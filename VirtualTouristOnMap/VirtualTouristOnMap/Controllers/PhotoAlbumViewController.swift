...
extension PhotoAlbumViewController: UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if pageLoadStatus {
            ...
            cell.flickrPhoto.image = UIImage(data: photo.image!)
        }
        else {
            cell.activityIndicator.startAnimating()
            cell.flickrPhoto.image = UIImage(named: "placeholder")
        }
        return cell
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if let selectedCell = collectionView.indexPathsForSelectedItems {
            ...
            do {
                ...
                Utilites.showMessage(title: "Error", message: "Error while trying to delete the Photo from collection.", view: self)
            }
